...
class Button(object):
    ...
    def __init__(self,
        ...
        if (self.xalign != None and self.yalign == None):
            log_warn("xalign is set but yalign is not, so yalign set to 0", "nqtr.button.Button.__init__")
            self.yalign = 0
        if (self.xalign == None and self.yalign != None):
            log_warn("yalign is set but xalign is not, so xalign set to 0", "nqtr.button.Button.__init__")
            self.xalign = 0
        if (isNullOrEmpty(self.button_icon) and isNullOrEmpty(self.picture_in_background)):
            log_info("You have set button_icon and picture_in_background to None, this action will be ignored", "nqtr.button.Button.__init__")
    ...
    def getButtonOrDefault(self) -> str:
        if (not isNullOrEmpty(self.button_icon)):
            ...
            log_error("You have set button_icon and picture_in_background to None, this button will be ignored", "nqtr.button.Button.getButtonOrDefault()")
        return ""
    ...
    def getPictureInBackgroundOrDefault(self) -> str:
        if (not isNullOrEmpty(self.picture_in_background)):
            ...
            log_error("You have set button_icon and picture_in_background to None, this button will be ignored", "nqtr.button.Button.getPictureInBackgroundOrDefault()")
        return ""
    ...
    def getSelectedButtonOrDefault(self) -> str:
        if (not isNullOrEmpty(self.button_icon_selected)):
            ...
            log_info("You have set button_icon_selected and picture_in_background_selected and button_icon and picture_in_background to None, this button will be ignored", "nqtr.button.Button.getSelectedButtonOrDefault()")
        return ""
    ...
    def getSelectedPictureInBackgroundOrDefault(self) -> str:
        if (not isNullOrEmpty(self.picture_in_background_selected)):
            ...
            log_error("You have set picture_in_background_selected and button_icon_selected and button_icon and picture_in_background to None, this button will be ignored", "nqtr.button.Button.getSelectedPictureInBackgroundOrDefault()")
        return ""
