...
label stage_talkalice:
    if (number_stages_completed_in_quest["alice"] == 0):
        ...
        $ add_conversation_choice(choice_character = a, choice_text = _("About the book"), label_name = "stage_talkalice", dict_choices = conversations)
        ...
        $ quest_next_stage(id = "alice")
        $ del_conversation_choice(choice_character = a, choice_text = _("About the book"), dict_choices = conversations)
    return
...
label stage_talkalice_aboutann:
    ...
    $ del_conversation_choice(choice_character = a, choice_text = _("About the Ann"), dict_choices = conversations)
    return
