...
label stage_talkalice:
    if (number_stages_completed_in_quest["alice"] == 0):
        ...
        $ add_talk_choice(choice_character = alice, choice_text = _("About the book"), label_name = "stage_talkalice", dict_choices = talkch_choices)
        ...
        $ quest_next_stage(id = "alice")
        $ del_talk_choice(choice_character = alice, choice_text = _("About the book"), dict_choices = talkch_choices)
    return
...
label stage_talkalice_aboutann:
    ...
    $ del_talk_choice(choice_character = alice, choice_text = _("About the Ann"), dict_choices = talkch_choices)
    return
