...
label after_return_from_room_navigation(label_name_to_call = ""):
    if isNullOrEmpty(label_name_to_call):
        call log_error("label_name_to_call is empty", renpy.get_filename_line())
    else:
    ...
    call log_error("thera is a anomaly in room_navigation. value: " + label_name_to_call, renpy.get_filename_line())
