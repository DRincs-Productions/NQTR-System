...
define quests = {
    ...
    "ann"  : Quest(id = "ann", title = _("Help [an]"), info_image = None,
...
label stagestart_talkalice:
    $ routine["stagealice1"] = Commitment(ch_talkobj_dict={"alice" : TalkObject()}, hour_start=14, hour_stop=20, location_id="house", room_id="terrace", event_label_name="stage_talkalice")
    return
