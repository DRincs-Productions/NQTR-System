...
define locations = {
        "house"     :   Location(id = "house", map_id="map", external_room_id="terrace", name=_("MC house"), icon="icon map home", xalign=0.3, yalign=0.2), 
}
...
default cur_location = locations[cur_room.location_id]
